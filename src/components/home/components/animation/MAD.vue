  ...
  data () {
    return {
      list: [
        {
          title: '热门推荐',
          img: 'http://img2.imgtn.bdimg.com/it/u=3021400971,1933570251&fm=26&gp=0.jpg',
          ps:
            '前方高能！让世界感受这场视觉盛宴吧！'
        },
        {

          img: 'http://img0.imgtn.bdimg.com/it/u=1030968274,592626266&fm=26&gp=0.jpg',
          ps:
            '《火影忍者博人传》沙动画极限2000幅，沙子绘制的动画效果炸裂堪比原作！'
        },
        {

          img: 'http://img0.imgtn.bdimg.com/it/u=1435633034,2865761648&fm=26&gp=0.jpg',
          ps:
            'B站宝贝'
        },
        {
