  ...
  data () {
    return {
      list: [
        {
          title: '热门推荐',
          img: 'http://img0.imgtn.bdimg.com/it/u=3225290254,4127910894&fm=26&gp=0.jpg',
          ps:
            '前方高能！让世界感受这场视觉盛宴吧！'
        },
        {

          img: 'http://img0.imgtn.bdimg.com/it/u=1364854552,2553884888&fm=26&gp=0.jpg',
          ps:
            '《火影忍者博人传》沙动画极限2000幅，沙子绘制的动画效果炸裂堪比原作！'
        },
        {

          img: 'http://img3.imgtn.bdimg.com/it/u=2872831684,1515023937&fm=26&gp=0.jpg',
          ps:
            'B站宝贝'
        },
        {

          img: 'http://img5.imgtn.bdimg.com/it/u=3976450400,3555234865&fm=26&gp=0.jpg',
          ps:
