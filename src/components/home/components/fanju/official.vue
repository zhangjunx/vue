  ...
  data () {
    return {
      list: [
        {
          title: '热门推荐',
          img: 'http://img2.imgtn.bdimg.com/it/u=1994746070,2714528134&fm=26&gp=0.jpg',
          ps:
            '前方高能！让世界感受这场视觉盛宴吧！'
        },
        {

          img: 'http://img0.imgtn.bdimg.com/it/u=1571659735,1298148635&fm=26&gp=0.jpg',
          ps:
            '《火影忍者博人传》沙动画极限2000幅，沙子绘制的动画效果炸裂堪比原作！'
        },
        {

          img: 'http://img4.imgtn.bdimg.com/it/u=1909675117,3062848501&fm=26&gp=0.jpg',
          ps:
            'B站宝贝'
        },
        {

          img: 'http://img5.imgtn.bdimg.com/it/u=1498812982,3149947151&fm=26&gp=0.jpg',
          ps:
