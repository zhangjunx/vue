  ...
  data () {
    return {
      list: [
        {
          title: '热门推荐',
          img: 'http://img1.imgtn.bdimg.com/it/u=2702529851,1700673198&fm=26&gp=0.jpg',
          ps:
            '前方高能！让世界感受这场视觉盛宴吧！'
        },
        {

          img: 'http://img1.imgtn.bdimg.com/it/u=1405509572,3879342843&fm=26&gp=0.jpg',
          ps:
            '《火影忍者博人传》沙动画极限2000幅，沙子绘制的动画效果炸裂堪比原作！'
        },
        {

          img: 'http://img2.imgtn.bdimg.com/it/u=159564899,551382033&fm=26&gp=0.jpg',
          ps:
            'B站宝贝'
        },
        {

          img: 'http://img3.imgtn.bdimg.com/it/u=1720799586,1675704021&fm=26&gp=0.jpg',
          ps:
